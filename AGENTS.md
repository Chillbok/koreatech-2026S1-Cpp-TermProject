...
- [x] 필수기능1: 회원제 운영 (회원/비회원 구분)
- [x] 필수기능2: 구매이력 기반 포인트/Advantage 기능
- [x] 필수기능3: 상품 구매 후 환불 기능
...
> **제품 번호 (serial)**: 각 옷 인스턴스를 고유하게 식별하는 16자리 16진수 해시값. `generate_random_hash()`로 생성되며, 환불 시 특정 옷을 식별하는 용도로 사용된다.
