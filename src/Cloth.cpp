...
Cloth::Cloth() : name(""), color(""), category(""), price(0), serial(generate_random_hash()) {}

Cloth::Cloth(string _name, string _color, string _category, int _price)
	: name(_name), color(_color), category(_category), price(_price), serial(generate_random_hash()) {}
